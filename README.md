...
The code is primarily meant to be used for comparison (i.e. you compare your code with mine). You can of course also download or clone the repository though. If you do that, you can `npm install` all dependencies and start the development server via `npm start`.# Kelv_AltSchool_Second_Sem_Assig
# Altschool_second_sem_Assig_2
# Altschool_second_sem_Assig_2
# second_sem_assig
